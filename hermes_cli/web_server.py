    ...
    try:
        ...
        try:
            ...
            if auth_required and interactive_providers:
                ...
                # OAuth providers broker the upstream IDP; password providers
                # complete at /login in the system browser. Token-only and
                # non-interactive providers are excluded by the registry view.
