...
_LONG_HANDLERS = frozenset({
    ...
    "wake.status", "session.active_list", "session.watch", "session.branch", "session.compress", "session.list",
...
def _request_principal(transport: Transport | None = None):
    ...
    explicit = getattr(active, "authenticated_principal", None)
...
GATEWAY_CAPABILITIES = ("session_watch_v1", "session_action_authority_v1")
